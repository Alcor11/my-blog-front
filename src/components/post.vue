<template>
    <article class="post post-list">
        <div class="post-entry">
            <div class="feature">
                <router-link :to="`/article/${post.docGuid}`">
                    <img :src="post.banner"/>
                </router-link>
            </div>
            <h1 class="entry-title">
                <router-link :to="`/article/${post.docGuid}`"><span v-if="post.isTop" style="color:#ff6d6d;font-weight:600">[置顶] </span>{{post.title}}</router-link>
            </h1>
            <div class="p-time">
            ...
            <p class="summary">{{post.docDesc}}</p>
            <footer class="entry-footer">
                <div class="post-more">
                    <router-link :to="`/article/${post.docGuid}`"><i class="iconfont iconfish-li" style="font-size: 25px;"></i></router-link>
                </div>
                <div class="info-meta">
                    <div class="comnum">
                        <span>
